...
set MAIN_CLASS=com.wts.common.Config

rem Java 命令行参数,根据需要开启下面的配置,改成自己需要的,注意等号前后不能有空格
rem set "JAVA_OPTS=-Xms256m -Xmx1024m -Dundertow.port=8089 -Dundertow.host=0.0.0.0"
rem set "JAVA_OPTS=-Dundertow.port=8089 -Dundertow.host=0.0.0.0"
